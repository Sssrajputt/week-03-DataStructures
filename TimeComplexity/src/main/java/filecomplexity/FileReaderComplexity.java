...
public class FileReaderComplexity {

    // Method to read a file and measure the complexity of file reading
    ...
    public void display() {
        ...
        System.out.println("Time Taken By FileReader Small File: " + timeTaken1);
        System.out.println(" ");
        ...
        System.out.println("Time Taken By FileReader Medium File: " + timeTaken2);
        System.out.println(" ");
        ...
        System.out.println("Time Taken By FileReader Large File: " + timeTaken3);
    }
}
